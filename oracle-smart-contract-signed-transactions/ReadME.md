# This is an demo React Express App for Oracle Smart Contract
...
<br/> 3. Updates the Smart Contract deployed in local ganache server:localhost:8545 with fetched Data
