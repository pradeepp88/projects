...
class Oracle extends Component {
    ...
    setContract = async (e)=>{
       ...
       var retPrice = await stockQuote.methods.getStockPrice(Web3.utils.fromAscii(this.props.data.symbol)).call();
       var retVolume = await stockQuote.methods.getStockVolume(Web3.utils.fromAscii(this.props.data.symbol)).call();
       this.setState({
        account: accounts[0],
